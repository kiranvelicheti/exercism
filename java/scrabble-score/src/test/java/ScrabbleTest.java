...
public class ScrabbleTest {
	...
	return Arrays.asList(new Object[][] { { "a", 1 }, { "A", 1 }, { "f", 4 }, { "at", 2 }, { "zoo", 12 },
		{ "street", 6 }, { "quirky", 22 }, { "OxyphenButazone", 41 }, { "pinata", 8 }, { "", 0 },
		{ "abcdefghijklmnopqrstuvwxyz", 87 }, });
    }

    public ScrabbleTest(String scrabbleInput, int scrabbleScore) {
